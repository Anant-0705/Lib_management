      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-semibold text-sm leading-none">Library Management System</p>
              <p className="text-slate-400 text-xs mt-0.5">University Library Portal</p>
            </div>
          </div>
          ...
          <div className="flex">
            {tabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2 text-sm font-medium border-b-2 transition-colors duration-150 ${
                  activeTab === tab.id
